		...
		method="post" enctype="multipart/form-data">
			...
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff" >
						<input type="text" name="mark_price" value="<s:property value="model.market_price"/>" id="userAction_save_do_logonName" class="bg"/>
					</td>
					<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
						商品商场价格：
					</td>
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff" colspan="3">
						<select name="is_host">
							...
							<option value="1" <s:if test="model.is_host == 1">selected</s:if>>是</option>
							<option value="0" <s:if test="model.is_host == 0">selected</s:if>>否</option>
						</select>
					</td>				
				</tr>
						<tr>
